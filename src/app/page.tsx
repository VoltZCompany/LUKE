            ...
            <>
              ...
              >
                {[
                  ...
                  { href: '/estoque', icon: '📦', label: 'Estoque', sublabel: 'Materiais Sagrados', gradient: 'from-teal-900/60 to-cyan-700/40', border: 'border-teal-500/30', glow: 'hover:shadow-teal-500/20' },
                ].map((item, i) => (
                  <motion.div
                    key={item.href}
